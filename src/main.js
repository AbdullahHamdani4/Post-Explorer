        ...
        return  `
         <div class="sideBarCard bg-sidebar-card hover:bg-sidebar-card-hover border border-sidebar-border shadow-card hover:shadow-card-hover pl-3.5 py-2 transition duration-500 rounded-2xl">
            ...
            <div class=" mt-3 flex justify-between pr-2">
              ...
              <button class="h-8 w-8 rounded border-card border hover:bg-blue transition duration-400 text-text-light hover:text-[#36454F]" onclick=showDetail(${each.id})><i class="fa-solid fa-arrow-right   text-xl "></i></button>
            </div>
          </div>
        `
...
const showDetail=async (id)=>{
   const response=await fetch(`https://dummyjson.com/posts/${id}`);
    ...
    postDetail.innerHTML=`
      <div class="postDetails h-full border border-post-border rounded-xl bg-card shadow-card  relative">
          ...
          <div class="postBody text-body-text text-body leading-6 p-8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis ea, exercitationem dolorem nostrum omnis
            iure quasi. Placeat doloribus provident odit! Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Accusamus, explicabo.
          </div>
          <div
